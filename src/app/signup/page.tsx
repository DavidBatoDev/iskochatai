...
const Signup: NextPage = () => {
  ...
  const { signUp, signInWithGoogle, signInWithFacebook, isAuthenticated } =
    useAuth();
          ...
          <form className="space-y-5 sm:space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  } rounded-md shadow-sm placeholder-gray-400 focus:outline-none text-xs sm:text-sm`}
                />
                {errors.username && (
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-center text-gray-500">
                You&apos;ll be prompted to complete your profile after signing
                up
              </p>
            </div>
          </form>
